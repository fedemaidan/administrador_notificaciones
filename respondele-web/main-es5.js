...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.get = function (url, endpoint, params, options) {
        var p = "";
    ...
    ApiService.prototype.post = function (url, endpoint, body, options) {
        return this.http.post(url + '/' + endpoint, body, options);
    };
    ApiService.prototype.put = function (url, endpoint, body) {
        return this.http.put(url + '/' + endpoint, body);
    };
    ApiService.prototype.delete = function (url, endpoint, value, headers) {
        return this.http.delete(url + "/" + endpoint + "/" + value);
    };
    ApiService.prototype.patch = function (url, endpoint, body) {
        return this.http.put(url + '/' + endpoint, body);
    };
...
var ConfiguracionComponent = /** @class */ (function () {
    ...
    ConfiguracionComponent.prototype.ngOnInit = function () {
        ...
        this.meli.urlIniML(accountInfo).subscribe(function (data) {
            console.log(data);
            _this.url = data.url;
        });
        if (!this.user.token)
...
var ConversacionComponent = /** @class */ (function () {
    function ConversacionComponent(user, meli, router, notifier) {
        this.user = user;
        this.meli = meli;
        this.router = router;
    ...
    ConversacionComponent.prototype.ngOnInit = function () {
        ...
        if (this.meli.pregunta) {
            ...
            this.meli.dameNombreUsuario(this.meli.pregunta.from)
                ...
                _this.prefijo = "Hola " + _this.usuarioPregunta + ".";
                _this.sufijo = " // Podes realizar la compra mediante Mercado Libre o mediante ------ @youtec.arg ------- InstG -----  tambien por nuestra Web Youtec /// Abonando por Transferencia Bancaria te podemos BONIFICAR 5% y Efec. 10% // Muchas gracias! - Somos @youtec.arg";
                _this.enviarPrefijo = true;
                _this.enviarSufijo = true;
            }, function (err) {
                console.log(err);
            });
        }
    ...
    ConversacionComponent.prototype.responder = function () {
        ...
        this.meli.responderPregunta({
            ...
            _this.notifier.notify('success', respuesta["msg"]);
    ...
    ConversacionComponent.ctorParameters = function () { return [
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(user, meli, router) {
        this.user = user;
        this.meli = meli;
        this.router = router;
    ...
    LoginComponent.prototype.resolveCaptcha = function () {
        console.log("resolvi");
    };
...
var MercadolibreService = /** @class */ (function () {
    function MercadolibreService(http, api, user) {
        this.http = http;
        this.api = api;
        this.user = user;
    ...
    MercadolibreService.prototype.urlIniML = function (params) {
        var accountInfo = this.user.cargarHeadersAutorizations(null);
        var seq = this.api.get(this.user.getApi(), 'cuentas/iniciarConML', params, accountInfo);
        return seq;
    };
    MercadolibreService.prototype.logoutML = function () {
        return "http://www.mercadolibre.com/jms/mla/lgz/logout";
    };
    MercadolibreService.prototype.removerCuentaML = function (body) {
        var _this = this;
        var headers = this.user.cargarHeadersAutorizations(body);
        var seq = this.api.delete(this.user.getApi(), 'cuentas/cuentas', body.nickname, headers);
    ...
    MercadolibreService.prototype.responderPregunta = function (datos) {
        var accountInfo = this.user.cargarHeadersAutorizations({});
        var seq = this.api.post(this.user.getApi(), 'preguntas/responder', datos, accountInfo);
        return seq;
    };
    MercadolibreService.prototype.sincronizarPreguntas = function (body) {
        var _this = this;
        var headers = this.user.cargarHeadersAutorizations({});
        var seq = this.api.post(this.user.getApi(), 'preguntas/sincronizar', body, headers);
        this.loading = true;
        seq.subscribe(function (res) {
            if (res.success == true) {
                _this.setPreguntas(res.data);
            }
            else {
                console.log(res);
            }
    ...
    MercadolibreService.prototype.actualizarConversaciones = function () {
        var _this = this;
        if (this.preguntas) {
    ...
    MercadolibreService.prototype.actualizarConveracionCon = function (pregunta) {
        var _this = this;
    ...
    MercadolibreService.prototype.dameNombreUsuario = function (from) {
        var seq = this.api.get(this.urlML, 'users/' + from.id, {});
        return seq;
    };
    MercadolibreService.prototype.setPregunta = function (pregunta) {
        this.pregunta = pregunta;
        this.actualizarConveracionCon(this.pregunta);
    };
    MercadolibreService.prototype.setPreguntaPorId = function (question_id) {
        var pregunta = this.preguntas.filter(function (pregunta) {
            return pregunta.question_id == question_id;
        });
        this.setPregunta(pregunta[0]);
    };
    MercadolibreService.prototype.removerPregunta = function () {
    ...
    // }
    MercadolibreService.prototype.actualizarPreguntas = function (showLoading) {
        /*    if (!this.socketOn) {
        ...
        var _this = this;
        var accountInfo = this.user.cargarHeadersAutorizations({});
        var seq = this.api.get(this.user.getApi(), 'preguntas/pregunta', {}, accountInfo);
    ...
    MercadolibreService.prototype.setPreguntas = function (preguntas) {
        var _this = this;
    ...
    MercadolibreService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
var NavegadorComponent = /** @class */ (function () {
    ...
    NavegadorComponent.prototype.toggleState = function () {
        var bool = this.isIn;
        this.isIn = bool === false ? true : false;
    };
    NavegadorComponent.ctorParameters = function () { return [
        { type: _user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] },
        { type: _mercadolibre_service__WEBPACK_IMPORTED_MODULE_3__["MercadolibreService"] }
    ]; };
...
var PreguntasComponent = /** @class */ (function () {
    ...
    PreguntasComponent.prototype.toggleMenu = function () {
        this.showMenu = !this.showMenu;
    };
    PreguntasComponent.ctorParameters = function () { return [
        { type: _mercadolibre_service__WEBPACK_IMPORTED_MODULE_2__["MercadolibreService"] },
        { type: _user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
...
var PublicacionComponent = /** @class */ (function () {
    function PublicacionComponent(meli) {
        this.meli = meli;
    }
    PublicacionComponent.prototype.ngOnInit = function () {
    };
    PublicacionComponent.ctorParameters = function () { return [
        { type: _mercadolibre_service__WEBPACK_IMPORTED_MODULE_2__["MercadolibreService"] }
    ]; };
...
var RecuperarContrasenaComponent = /** @class */ (function () {
...
var RegistracionComponent = /** @class */ (function () {
    function RegistracionComponent(user, router) {
        this.user = user;
        this.router = router;
        this.account = {
            name: '',
    ...
    RegistracionComponent.ctorParameters = function () { return [
        { type: _user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.hasUser = function () {
        return localStorage.getItem('_user');
    };
    UserService.prototype.dameNickname = function (id) {
        var aux = "a";
    ...
    UserService.prototype.cargarUsuario = function (user, token) {
        this.loading = true;
        this._user = user;
        this.token = token;
    ...
    UserService.prototype.recuperarContrasena = function (accountInfo) {
        accountInfo = this.cargarHeadersAutorizations(accountInfo);
    ...
    UserService.prototype.signup = function (accountInfo) {
        var _this = this;
        accountInfo = this.cargarHeadersAutorizations(accountInfo);
        var seq = this.api.post(this.url, 'login/signup', accountInfo);
        seq.subscribe(function (res) {
    ...
    UserService.prototype.actualizarCuentas = function (accountInfo) {
        var _this = this;
        accountInfo = this.cargarHeadersAutorizations(accountInfo);
        var seq = this.api.get(this.url, 'cuentas/cuentas', {}, accountInfo);
        seq.subscribe(function (res) {
            if (res.success == true) {
                _this.cuentas = res.data;
                localStorage.setItem('cuentas', JSON.stringify(_this.cuentas));
                _this.loading = false;
            }
            else {
    ...
    UserService.prototype.dameToken = function (ml_id) {
    ...
    UserService.prototype.cargarHeadersAutorizations = function (options) {
        if (!options) {
            options = {};
        }
        if (this.token) {
    ...
    UserService.prototype.cantidadDeCuentas = function () {
        if (this.cuentas) {
